object Versions {
  ...
  val coulomb                = "0.8.0"
  val clue                   = "0.40.0"
  val crystal                = "0.45.3-25-d338726-20241206T224546Z-SNAPSHOT"
  ...
  val lucumaCatalog          = "0.48.9"
  val lucumaITC              = "0.24.1"
  val lucumaReact            = "0.73.2"
  val lucumaRefined          = "0.1.3"
  val lucumaSchemas          = "0.108.0"
  val lucumaOdbSchema        = "0.17.0"
  val lucumaSSO              = "0.7.0"
  val lucumaUI               = "0.124.1-10-a600bc0-20241206T221401Z-SNAPSHOT"
  val monocle                = "3.3.0"
  val mouse                  = "1.3.2"
  val mUnit                  = "1.0.3"
