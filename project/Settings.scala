...
object Settings {
  ...
  object LibraryVersions {
    ...
    val clue              = "0.18.2"
    val crystal           = "0.16.0+14-a833d8f4+20211007-1303-SNAPSHOT"
    ...
    val lucumaBC          = "0.3.0"
    val lucumaCore        = "0.13.4+3-bd2afd8a+20211007-1229-SNAPSHOT"
    val lucumaCatalog     = "0.5.1+55-cc7d3d42+20211007-1340-SNAPSHOT"
    val lucumaUI          = "0.17.1"
