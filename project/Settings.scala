...
object Settings {
  ...
  object LibraryVersions {
    ...
    val lucumaBC          = "0.3.2"
    val lucumaCore        = "0.23.1"
    val lucumaCatalog     = "0.9.0+0-35efa5e7+20220112-1555-SNAPSHOT"
    val lucumaUI          = "0.23.0"
    val lucumaSchemas     = "0.6.0+1-565414fd+20220112-1550-SNAPSHOT"
    val lucumaSSO         = "0.0.13"
    val monocle           = "3.1.0"
    val mouse             = "1.0.8"
    val mUnit             = "0.7.29"
    val mUnitCatsEffect   = "1.0.7"
    val reactAladin       = "0.12.0"
