...
object Settings {
  ...
  object LibraryVersions {
    ...
    val lucumaBC            = "0.4.0"
    val lucumaCore          = "0.31.0"
    val lucumaCatalog       = "0.13.0"
    val lucumaUI            = "0.33.0"
    val lucumaSchemas       = "0.17.0"
    val lucumaSSO           = "0.1.3"
    val monocle             = "3.1.0"
    val mouse               = "1.0.10"
    val mUnit               = "0.7.29"
    val mUnitCatsEffect     = "1.0.7"
    val reactAladin         = "0.18.1"
    val reactAtlasKitTree   = "0.4.2"
    val reactClipboard      = "1.5.1"
    val reactCommon         = "0.16.0"
    val reactDatepicker     = "0.4.1"
    val reactGridLayout     = "0.15.0"
    val reactHighcharts     = "0.4.4"
    val reactHotkeys        = "0.4.0"
    val reactResizable      = "0.8.0"
    val reactSemanticUI     = "0.15.0"
