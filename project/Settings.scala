...
object Settings {
  ...
  object LibraryVersions {
    ...
    val lucumaBC          = "0.4.0"
    val lucumaCore        = "0.25-be5c2ec-SNAPSHOT"
    val lucumaCatalog     = "0.10.0+20-f6eb0ecd+20220223-1823-SNAPSHOT"
    val lucumaUI          = "0.25.0"
    val lucumaSchemas     = "0.12.0-20220223T211710Z-SNAPSHOT"
    val lucumaSSO         = "0.0.14"
    val monocle           = "3.1.0"
    val mouse             = "1.0.10"
    val mUnit             = "0.7.29"
    val mUnitCatsEffect   = "1.0.7"
    val reactAladin       = "0.13.0"
