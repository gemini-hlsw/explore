...
object Settings {
  ...
  object LibraryVersions {
    ...
    val coulomb                = "0.7.3"
    val clue                   = "0.28.1"
    val crystal                = "0.33.9-26-793b44d-20230331T152454Z-SNAPSHOT"
    ...
    val lucumaBC               = "0.4.0"
    val lucumaCore             = "0.71.1"
    val lucumaCatalog          = "0.40.0"
    val lucumaReact            = "0.33.0"
    val lucumaRefined          = "0.1.1"
    val lucumaSchemas          = "0.47.0-11-69dfc91-20230331T203058Z-SNAPSHOT"
    val lucumaSSO              = "0.5.4"
    val lucumaUI               = "0.69.0"
    val monocle                = "3.2.0"
    val mouse                  = "1.2.1"
