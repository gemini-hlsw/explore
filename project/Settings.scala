...
object Settings {
  ...
  object LibraryVersions {
    ...
    val lucumaBC            = "0.4.0"
    val lucumaCore          = "0.40.0"
    val lucumaCatalog       = "0.17.1"
    val lucumaUI            = "0.36.1-2-793c1fd-20220610T001155Z-SNAPSHOT"
    val lucumaSchemas       = "0.25.1"
    val lucumaSSO           = "0.1.10"
    val monocle             = "3.1.0"
    val mouse               = "1.0.11"
    val mUnit               = "0.7.29"
    val mUnitCatsEffect     = "1.0.7"
    val reactAladin         = "0.21.2"
