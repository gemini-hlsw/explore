...
ALTER TABLE "public"."lucumaGridLayoutPositions" ALTER COLUMN "created_at" TYPE timestamp with time zone;

ALTER TABLE "public"."lucumaGridLayoutPositions" ALTER COLUMN "updated_at" TYPE timestamp with time zone;
