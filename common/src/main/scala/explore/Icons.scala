...
object Icons {
  ...
  @js.native
  @JSImport("@fortawesome/pro-regular-svg-icons", "faArrowUpRightFromSquare")
  val faArrowUpRightFromSquare: FAIcon = js.native
  ...
  @js.native
  @JSImport("@fortawesome/pro-light-svg-icons", "faTrashCanUndo")
  ...
  @js.native
  @JSImport("@fortawesome/pro-solid-svg-icons", "faLink")
  ...
  @js.native
  @JSImport("@fortawesome/pro-regular-svg-icons", "faNote")
  val faNote: FAIcon = js.native
  ...
  @js.native
  @JSImport("@fortawesome/pro-regular-svg-icons", "faEye")
  val faEye: FAIcon = js.native
  ...
  @js.native
  @JSImport("@fortawesome/pro-solid-svg-icons", "faChevronsLeft")
  ...
  @js.native
  @JSImport("@fortawesome/pro-regular-svg-icons", "faStar")
  val faStar: FAIcon = js.native

  @js.native
  @JSImport("@fortawesome/pro-regular-svg-icons", "faStars")
  ...
  @js.native
  @JSImport("@fortawesome/pro-solid-svg-icons", "faCrystalBall")
  val faCrystalBall: FAIcon = js.native

  @js.native
  @JSImport("@fortawesome/pro-thin-svg-icons", "faSliders")
  val faThinSliders: FAIcon = js.native

  @js.native
  @JSImport("@fortawesome/pro-light-svg-icons", "faCircle")
  val faCircle: FAIcon = js.native

  @js.native
  @JSImport("@fortawesome/pro-solid-svg-icons", "faCircle")
  val faCircleSolid: FAIcon = js.native
  ...
  @js.native
  @JSImport("@fortawesome/pro-regular-svg-icons", "faHourglassClock")
  val faHourglassClock: FAIcon = js.native

  @js.native
  @JSImport("@fortawesome/pro-regular-svg-icons", "faPlanetRinged")
