...
import * as hastToReact from "property-information/hast-to-react.json";
import * as spaces from "space-separated-tokens";
import * as commas from "comma-separated-tokens";
...
function toReact(context, node, index, parent) {
    ...
    const component = options.components && own.call(options.components, name)
...
function addProperty(props, prop, value, ctx) {
    ...
    if (info.space) {
        props[own.call(hastToReact, info.property)
...
export { toReact as hastToReact };
export { childrenToReact as hastChildrenToReact };
