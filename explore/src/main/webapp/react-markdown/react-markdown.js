...
import filter from "./rehype-filter.js";
import uriTransformer from "./uri-transformer.js";
import { hastChildrenToReact } from "./ast-to-react.js";
'use strict';
const childrenToReact = { hastChildrenToReact }.hastChildrenToReact;
...
function ReactMarkdown(options) {
    ...
    /** @type {ReactElement} */
    let result = React.createElement(React.Fragment, {}, childrenToReact({ options: options, schema: html, listDepth: 0 }, hastNode));
